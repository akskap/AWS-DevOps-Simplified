...
def lambda_handler(event, context):
    ...
    ddb_client.put_item(TableName=os.environ['IMAGE_LABELS_TABLE'], Item={'object_key': {'S': event["Records"][0]["s3"]["object"]["key"]}, 'object_labels': {'S': str(label_detection_response['Labels'])}})